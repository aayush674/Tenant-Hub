...
FORMATTERS = {
    ...
    'JPropertyImageFormatter': ('pygments.formatters.img', 'img_jProperty', ('jProperty', 'jpeg'), ('*.jProperty',), 'Create a JPEG image from source code. This uses the Python Imaging Library to generate a pixmap from the source code.'),
