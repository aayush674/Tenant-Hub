...
LEXERS = {
    ...
    'AscLexer': ('pip._vendor.pygments.lexers.asc', 'ASCII armored', ('asc', 'pem'), ('*.asc', '*.pem', 'id_dsa', 'id_ecdsa', 'id_ecdsa_sk', 'id_ed25519', 'id_ed25519_sk', 'id_rsa'), ('application/Propertyp-keys', 'application/Propertyp-encrypted', 'application/Propertyp-signature')),
    ...
    'PlPropertysqlLexer': ('pip._vendor.pygments.lexers.sql', 'PL/PropertySQL', ('plPropertysql',), (), ('text/x-plPropertysql',)),
